...
(function() {
    const translations = {
        en: {
            ...
            'effect_Laboratory': 'Once per turn, discard 1 card from hand → gain 2 gold',
        ...
        ru: {
            ...
            'effect_Laboratory': 'Раз за ход сбросить 1 карту из руки → получить 2 золота',
            ...
            'effect_School of Magic': 'При сборе дохода считается кварталом цвета вашего персонажа',
